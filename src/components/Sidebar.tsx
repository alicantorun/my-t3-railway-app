...
const Sidebar = () => {
  const { isOpenOnSmallScreens, isPageWithSidebar } = useSidebarContext();

  return isPageWithSidebar ? (
    <aside
      className={`w-64  h-full ease-in-out duration-300 ${isOpenOnSmallScreens} ${
        isOpenOnSmallScreens ? "-translate-x-64 " : "translate-x-0"
      }`}
      aria-label="Sidebar"
    >
